---
title: "ejv98_PeerCommentary_nkelley_04"
...
```
NK: you needed one more bracket at the end of your function to close it. Otherwise, it seems to work well! 
...
```
NK: This looks good! I was uncertain if we needed to use M2 or just M1, but I also used M1. 
...
ggM2
```
NK: for the ggplot, you had data=info, which I assumed was supposed to be df2? I also adjusted some of the parentheses which seemed to be slightly off. The plot runs now, although if df2 is the wrong info, you'll want to replace that. Something I've found helpful is when you click next to a bracket/parenthese/etc. it highlights the corresponding one. This makes it easier to see which sections are bound together, or if you've forgotten to close something.
...
NK: Your code was overall much better than mine! Great job. I like how you organize your work/annotations as well.  
